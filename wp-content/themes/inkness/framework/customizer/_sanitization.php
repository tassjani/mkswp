...
function inkness_sanitize_checkbox( $input ) {
    if ( $input == 1 ) {
        return 1;
    } else {
        return '';
...
function inkness_sanitize_positive_number( $input ) {
...
function inkness_sanitize_category( $input ) {
...
function inkness_sanitize_product_category( $input ) {
